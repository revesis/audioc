...
var FFT = /*#__PURE__*/function () {
  ...
  _createClass(FFT, [{
    ...
    value: function calculateSpectrum() {
      ...
      var real = this.real;
      var imag = this.imag;
      for (var i = -1, bSi = 2 / bufferSize, N = bufferSize; ++i < N;) {
        var rval = real[i];
        var ival = imag[i];
...
var PhaseVocoder = /*#__PURE__*/function () {
  function PhaseVocoder(winSize, sampleRate) {
    ...
    this.stftObj = {
      inputFrame: new Float32Array(winSize),
      zeros: new Float32Array(winSize)
    };
    this.pvStepObj = {
  ...
  _createClass(PhaseVocoder, [{
    ...
    value: function process(inputArray, outputArray) {
      ...
      this.stft(inputArray, framingWindow, fftObj);
    ...
    key: "stft",
    value: function stft(inputFrame, windowFrame, fftObj) {
      var winSize = this.winSize;
      var fft = this.fft;
      var hlfSize = Math.round(winSize >> 1) + 1;
      ...
      fft.forward(this.stftObj.inputFrame);
    ...
    value: function istft(real, imag, timeFrame) {
      ...
      // let frame = fft.inverse(real, imag);
...
var BPV = /*#__PURE__*/function () {
  ...
  _createClass(BPV, [{
    ...
    value: function process(outputBuffer) {
      ...
      var ir = buffer.getChannelData(0);
...
var AudioC = /*#__PURE__*/function () {
  ...
  function AudioC(params) {
    ...
    _defineProperty(this, "amr", void 0);
    ...
    _defineProperty(this, "ctxLoadStart", void 0);
    _defineProperty(this, "bufferLoadOffset", void 0);
    _defineProperty(this, "srcSec", void 0);
    _defineProperty(this, "waitID", void 0);
    _defineProperty(this, "waitTime", void 0);
    _defineProperty(this, "totalTime", void 0);
    _defineProperty(this, "playbackRate", 1.0);
    _defineProperty(this, "gainValue", 1.5);
    _defineProperty(this, "onended", void 0);
    _classPrivateFieldInitSpec(this, _wait, {
      writable: true,
      value: function value(ms) {
        return new Promise(function (resolve) {
          return _this.waitID = _this.waitID && clearTimeout(_this.waitID) || setTimeout(resolve, ms);
        });
      }
    });
    !params && (params = {});
  ...
  _createClass(AudioC, [{
    ...
    value: function loadUrl(url) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        xhr.onerror = function (event) {
          reject(new Error("Failed to fetch ".concat(url)));
        };
        xhr.send();
      }).then(function (data) {
        return _classPrivateMethodGet(_this3, _decodeBuffer, _decodeBuffer2).call(_this3, data);
      });
    }
  }, {
    key: "playAudio",
    ...
    value: function skipAudio(offset) {
      ...
      (function rec(self) {
        ++self.srcSec;
        _classPrivateFieldGet(self, _wait).call(self, self.waitTime).then(function () {
          return rec(self);
        });
      })(this);
    }
...
function _decodeBuffer2(audioData) {
  ...
  return new Promise(function (resolve) {
    ...
    var buffer;
    try {
      buffer = _this4.ctx.createBuffer(1, decodedData.length, _this4.sampleRate);
    } catch (ignore) {
      // iOS 不支持 22050 以下的采样率，于是先提升采样率，然后用慢速播放
      if (_this4.sampleRate < 11025) {
        buffer = _this4.ctx.createBuffer(1, decodedData.length, _this4.sampleRate * 4.0);
        _this4.playbackRate = 0.25;
      } else {
        buffer = _this4.ctx.createBuffer(1, decodedData.length, _this4.sampleRate * 2.0);
        _this4.playbackRate = 0.5;
      }
    } finally {
    ...
    _this4.bufferLoadOffset = (new Date() - _this4.ctxLoadStart) / 1000;
    _this4.sampleRate = buffer.sampleRate;
    _this4.buffer = buffer;
    _this4.totalTime = buffer.duration;
    _this4.srcSec = 0 && ++_this4.srcSec;
    // this.interID && clearInterval(this.interID);
    _this4.waitID && clearTimeout(_this4.waitID);
  })["catch"](function (e) {
...
function _start2() {
  ...
  this.processor.onaudioprocess = function (event) {
    ...
    if (void 0 !== self.playbackRate) {
      var stretchFactor = self.playbackRate; // 倍速播放
